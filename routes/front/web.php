...
Route::group(['namespace' => 'Front'], function () {
    ...
    Route::get('/danh-muc/{slug}','FrontController@getCategoryProduct')->name('front.getCategoryProduct');
    Route::get('/san-pham/{slug}','FrontController@getProductDetail')->name('front.getProductDetail');
    Route::get('/thuong-hieu/{slug}','FrontController@getManufactureProduct')->name('front.getManufactureProduct');
    ...
    Route::get('/remove-all-item','CartController@removeAllItem')->name('cart.removeAllItem');
    ...
    Route::get('/gioi-thieu','FrontController@about_page')->name('front.about_page');
    ...
    Route::get('/{cateSlug}/{manufactureSlug}','FrontController@getProductByManuAndCate')->name('front.getProductByManuAndCate');
