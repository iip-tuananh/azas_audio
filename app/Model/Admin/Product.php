...
class Product extends BaseModel
{
    ...
    public function attrs() {
        return $this->belongsToMany(Attribute::class, 'attribute_values', 'product_id', 'attribute_id')->withPivot('value', 'attribute_id');
    }
    ...
    public static function searchByFilter($request)
    {
        ...
        if (!empty($request->manu_id)) {
            $result = $result->where('manufacturer_id', $request->manu_id);
        }
