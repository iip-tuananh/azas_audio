...
class CartController extends Controller
{
    ...
    public function index()
    {
        ...
        $banner = BannerPage::query()->with('image')->find(4);

        return view($this->view . '.orders.cart', compact('cartCollection', 'total_price', 'total_qty', 'banner'));

//        return view('site.orders.cart', compact('cartCollection', 'total_price', 'total_qty', 'banner'));
    }
    ...
    public function checkout(Request $request) {
        ...
        return view('site.orders.checkout', compact('cartCollection', 'total' ,'cartItems', 'totalPriceCart', 'config', 'provinces', 'districts', 'wards'));
    }
    ...
    public function checkoutSubmit(Request $request)
    {
        ...
        try {
            $translate = [
                ...
                'customer_province.required' => 'Vui lòng chọn tỉnh/thành',
