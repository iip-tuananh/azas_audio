...
{{--            </li>--}}
            ...
            @php
                // Mở group khi đang ở bất kỳ trang hàng hóa nào
                $productMenuOpen = request()->routeIs(
                    'Product.*',
                    'Category.*',
                    'manufacturers.*',
                    'attributes.*'
                )
                // Giữ lại các pattern URI bạn đang dùng
                || request()->is('admin/solutions*', 'admin/category-special*');
            @endphp

            <li class="nav-item has-treeview {{ $productMenuOpen ? 'menu-open' : '' }}">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('manufacturers.index') }}"
                           class="nav-link {{ Request::routeIs('manufacturers.index') ? 'active' : '' }}">
...
{{--            </li>--}}
            ...
            <li class="nav-item has-treeview  {{ request()->is('admin/stores') ||  request()->is('admin/banners') ||  request()->is('admin/origins')
|| request()->is('admin/manufacturers/*') || request()->is('admin/attributes') || request()->is('admin/policies') || request()->is('admin/policies/*') ? 'menu-open' : '' }} ">
