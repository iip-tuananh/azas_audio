...
@section('css')
    <link rel="stylesheet" href="/site/custom-css/brand-list.css">
    <link rel="stylesheet" href="/site/custom-css/manufacture-list.css">
@endsection
        ...
        <div class="col_sub">
            <div class="box thin_box brand_details">
                ...
                <div class="bd brand_info">
                    <p class="description">
                        <img src="{{ $manufacture->image->path ?? '' }}">
                    </p>
                    <ul class="cat_list">
...
@push('scripts')
    <script src="/site/custom-js/manufacture-list.js"></script>
@endpush
