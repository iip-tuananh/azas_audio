    ...
    <div class="col-sm-8">
        ...
        <div class="form-group custom-group mb-4">
            ...
            <ui-select class="" remove-selected="true" ng-model="form.manufacturer_id" theme="select2">
                <ui-select-match placeholder="Chọn thương hiệu">
                    <% $select.selected.name %>
                </ui-select-match>
                <ui-select-choices repeat="t.id as t in (form.all_manufactures | filter: $select.search)" >
                    <span ng-bind="t.name"></span>
                </ui-select-choices>
            </ui-select>
            <span class="invalid-feedback d-block" role="alert">
...
{{--        <div class="form-group text-center">--}}
{{--            <div class="main-img-preview">--}}
{{--                <label for="">Ảnh sản phẩm (ảnh phụ)</label>--}}
{{--                <p class="help-block-img">* Ảnh định dạng: jpg, png.</p>--}}
