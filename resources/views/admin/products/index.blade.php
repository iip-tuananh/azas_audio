    ...
    <script>
        let datatable = new DATATABLE('table-list', {
            ...
            columns: [
                ...
                {data: 'manufacturer_id', title: 'Thương hiệu'},
                {
                    data: 'status',
                    title: "Trạng thái",
                    render: function (data) {
            ...
            search_columns: [
                ...
                {
                    data: 'manu_id', search_type: "select", placeholder: "Thương hiệu",
                    column_data: @json(App\Model\Admin\Manufacturer::getForSelect())
                },
            ],
        }).datatable;
